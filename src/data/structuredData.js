...
export const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How does A3 Distributor stand out in pricing and product selection compared to other one-stop wholesale suppliers?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What advantages does working with A3 Distributor offer for sourcing a wide range of products?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What bulk purchase discounts does A3 Distributor offer?",
      "acceptedAnswer": {
        "@type": "Answer",
